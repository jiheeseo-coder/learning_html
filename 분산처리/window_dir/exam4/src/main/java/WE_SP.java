...
public class WE_SP {
    public static StormTopology buildTopology() throws Exception{
        ...
        windowConfig = SlidingDurationWindow.of(new BaseWindowedBolt.Duration(3000, TimeUnit.MILLISECONDS),
                                                new BaseWindowedBolt.Duration(1000, TimeUnit.MILLISECONDS));
    ...
    public static void main(String[] args) throws Exception {
        ...
        StormSubmitter.submitTopologyWithProgressBar("sliding", conf, buildTopology());
        Thread.sleep(20000);
